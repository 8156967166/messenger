...
final class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped() {
        ...
        DataBaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                //User already exists
                self?.alertUserLoginError(message: "Please enter all the Information to create a new account")
                return
            }
            
            FirebaseAuth.Auth.auth().createUser(withEmail: email, password: password) { authRslt, error in
               
                guard let result = authRslt, error == nil else {
    ...
    @objc private func didTapChangeProfilePic() {
        print("change profile pic clicked")
