...
//  Messenger
//
//  Created by Aneesha on 15/12/23.
//
...
//        safeEmail = safeEmail.replacingOccurrences(of: "@", with: "-")
    ...
    public enum DatabaseError: Error {
        ...
        public var localizationDescrption: String {
            switch self {
                case .failedToFetch:
                    return "failed"
            }
...
extension DataBaseManager {
    ...
    //Return dictnry node at child path
    ...
    public func getAllConversation(for email: String, completion: @escaping (Result<[Conversation], Error>) -> Void) {
        database.child("\(email)/conversations").observe(.value, with: { snapshot in
            ...
            let conversations: [Conversation] = value.compactMap({ dictionary in
                ...
                let latestMessageObject = LatestMeesage(date: date,
                                                        text: message,
                                                        isRead: isRead)
            ...
            let messages: [Message] = value.compactMap({ dictionary in
              guard let name = dictionary["name"] as? String,
                ...
                // video
                    ...
                    let locationComponet = content.components(separatedBy: ",")
                    guard let longitude = Double(locationComponet[0]), let latitude = Double(locationComponet[1]) else {
                        return nil
                    }
                ...
                strongSelf.database.child("\(currentEmail)/conversations").observeSingleEvent(of: .value, with: { snapshot in
                    ...
                    if var currentUserConversations = snapshot.value as? [[String: Any]] {
                        ...
                        for conversationDictionary in currentUserConversations {
                            if let curentId = conversationDictionary["id"] as? String, curentId == conversation {
                        ...
                        strongSelf.database.child("\(otherUserEmail)/conversations").observeSingleEvent(of: .value, with: { snapshot in
                            ...
                            if var otherUserConversations = snapshot.value as? [[String: Any]] {
                                ...
                                if var targetConversation = targetConversation {
                                    ...
                                    // faield to find in current collection
                                    let newConversationData = [
                                        "id" : conversation,
...
//                        completion(true)
    ...
    public func deleteConversation(conversatioId: String, completion: @escaping(Bool) -> Void) {
        ...
        print("Deleting conversation with id: \(conversatioId)")
